...
<div class="wrapper">
    ...
    <section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}'
             style="background-image: url(images/articals.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li><a href="article.php"> Article</a> <i class="fa fa-angle-double-right"></i>
                        </li>
                    ...
                    <div class="blog-entry">
                        <div class="blog-detail">
                            <div class="entry-title mb-10">
                                <h4 class="text-capitalize">test title</h4>
                            </div>
                            ...
                            <div class="entry-content">
                                <p class="text-justify">Consectetur, assumenda provident this exercise dolor sit amet, consectetur
